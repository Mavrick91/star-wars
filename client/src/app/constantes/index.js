...
export const openingCrawl = () => {
  return (
    <>
      ...
      <br />
      <p>
        According to all know laws of aviation, there is no way a bee should be
        able to fly. It&apos;s wings are too small to get it&apos;s fat little
        body off the ground.
      </p>
      <p>
        The bee, of course, flies anyway because bee don&apos;t care what humans
        think is impossible
      </p>
